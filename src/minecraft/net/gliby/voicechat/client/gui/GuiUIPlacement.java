...
public class GuiUIPlacement extends GuiScreen {
	...
	public void drawScreen(int x, int y, float tick) {
		...
		drawCenteredString(fontRenderer, StringTranslate.getInstance().translateKey("menu.pressESCtoReturn"), (width / 2), 2, -1);
		...
		if (lastSelected != null) {
			scaleSlider.setDisplayString(StringTranslate.getInstance().translateKey("menu.scale") + ": " + (int) (lastSelected.scale * 100) + "%");
			...
			positionTypeButton.displayString = StringTranslate.getInstance().translateKey("menu.position") + ": " + positionTypes[lastSelected.positionType];
	...
	@Override
	public void initGui() {
		positionTypes[0] = StringTranslate.getInstance().translateKey("menu.positionAutomatic");
		positionTypes[1] = StringTranslate.getInstance().translateKey("menu.positionAbsolute");
		if (scaleSlider == null) {
		...
		buttonList.add(resetButton = new GuiButton(1, 2, 2, 96, 20, StringTranslate.getInstance().translateKey("menu.resetLocation")));
