...
public class ServerConfiguration {
	...
	public boolean save() {
		...
		this.init.WriteComment("Network", "0 - Minecraft Network, 1 - UDP Network. UDP networking improves performance and network speeds extensively, it is highly recommended.");
		...
		this.init.WriteComment("Network", "Client Quality levels, starting from 0 to 9. If you want to reduce bandwidth, make the maximum quality smaller. If you'd like to make sound quality great, set the minimum quality to a high value.");
		...
		this.init.WriteComment("Network", BUFFER_SIZE + " - recommended buffer size is 128, max 500, going any higher will cause issues. Buffer Size is how much voice data gets sent every single voice packet, big buffers equal in big latency. If you are experiencing stuttering with players, or having network lag - set this to a higher value. ");
